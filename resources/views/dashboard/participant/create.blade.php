...
@section('content')
    <div>
        <div class="w-full rounded-lg bg-white p-5">
            <h2 class="mb-3 text-xl font-semibold">Tambah Peserta</h2>
            ...
            <form action="{{ route('participant.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <select class="block w-full cursor-pointer rounded-sm focus:outline-none" id="training"
                        name="training_id" data-training-id="{{ old('training_id') }}" placeholder="Pilih Pelatihan..."
                        autocomplete="off">
